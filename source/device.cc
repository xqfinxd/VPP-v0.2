...
void Renderer::initInstance() {
    ...
    auto debugCI = vk::DebugUtilsMessengerCreateInfoEXT()
        .setPNext(nullptr)
        .setMessageSeverity(MsgSeverity::eInfo |
            MsgSeverity::eWarning |
            MsgSeverity::eError)
        .setMessageType(MsgType::eGeneral |
            MsgType::eValidation |
...
bool Renderer::checkDeviceExtension(const vk::PhysicalDevice& candidateGpu,
...
bool Renderer::checkPhysicalDevice(const vk::PhysicalDevice& gpu) const {
    ...
    if (extensionsSupported) {
        ...
        swapchainAdequate = !(surfSupport.formats.empty() ||
            surfSupport.presentModes.empty());
    }
